      ...
      structure: (S) =>
        S.list()
          ...
          .items([
            ...
            S.listItem().title("Governance Bodies").schemaType("governanceBody").child(S.documentTypeList("governanceBody")),
            S.listItem().title("Governance Principles").schemaType("governancePrinciple").child(S.documentTypeList("governancePrinciple")),
            S.listItem().title("Governing Documents").schemaType("governanceDocument").child(S.documentTypeList("governanceDocument")),
